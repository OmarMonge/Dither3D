...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    public class Camera3 : MonoBehaviour
    {
        ...
        public bool stationaryMode = false; // Toggle for stationary camera
        public Transform stationaryTransform; // The transform where the camera should move
        ...
        public void ToggleStationaryMode(Transform newCameraTransform)
        {
            ...
            if (stationaryMode && stationaryTransform != null)
            {
                ...
                transform.LookAt(targetTransform.position + offsetFromHead);
            }
        ...
        void Update()
        {
            ...
            if (!stationaryMode) // Only process camera input if NOT in stationary mode
            {
        ...
        void UpdateCamera(float dt)
        {
            ...
            if (stationaryMode && stationaryTransform != null)
            {
                // Keep camera at the assigned transform position and rotation
                transform.position = stationaryTransform.position;
                 transform.LookAt(targetTransform.position + offsetFromHead); // Ensures it faces the character
                return;
            }
            // Body visibility ---------------------------------------------------------------------
